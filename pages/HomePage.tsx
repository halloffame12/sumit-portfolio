      ...
      <div className="h-full flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center min-h-[70vh]">
          ...
          >
            ...
            <img src="https://i.postimg.cc/rwjfhvrk/sumitc.png" alt="Profile" className="relative w-48 h-48 lg:w-72 lg:h-72 object-cover rounded-full border-4 border-secondary-light dark:border-secondary-dark shadow-2xl" />
          </motion.div>
        </div>
